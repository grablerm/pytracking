...
def parameters():
    ...
    # Training parameters
    params.sample_memory_size = 250     # Memory size default =250
    params.train_skipping = 10          # How often to run training (every n-th frame) default =10
    ...
    params.distractor_threshold = 0.3           # Relative threshold to find distractors default=0.8
