...
def run_tracker(tracker_name='atom', tracker_param='default', run_id=None, dataset_name='otb', sequence=None, debug=0, threads=0,
                visdom_info=None):
    ...
    trackers = [Tracker(tracker_name, tracker_param, run_id), Tracker(tracker_name, tracker_param, run_id)]
...
def main():
    ...
    parser.add_argument('--start_frame', type=int, default=1, help='Number of start frame.')
