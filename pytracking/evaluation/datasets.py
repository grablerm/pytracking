...
dataset_dict = dict(
    ...
    otb2=DatasetInfo(module=pt % "otb2", class_name="OTBDataset", kwargs=dict()),
    ...
    cocoseq=DatasetInfo(module="ltr.dataset.coco_seq", class_name="MSCOCOSeq", kwargs=dict(version="2014", split="train")),
    coco=DatasetInfo(module="ltr.dataset.coco", class_name="MSCOCO", kwargs=dict(version="2014", split="train")),
    coco2017=DatasetInfo(module="ltr.dataset.coco", class_name="MSCOCO", kwargs=dict(version="2017", split="val")),
    coco2017seq=DatasetInfo(module="ltr.dataset.coco_seq", class_name="MSCOCOSeq", kwargs=dict(version="2017", split="val"))
...
def load_dataset(name: str):
    ...
    ds = dataset.get_sequence_list()
    print("Dset info done ")
    return ds
